...
hi Visual	guifg=darkcyan guibg=fg	gui=reverse	ctermfg=lightblue ctermbg=fg cterm=reverse
hi VisualNOS	guifg=darkcyan guibg=fg	gui=reverse,underline	ctermfg=lightblue ctermbg=fg cterm=reverse,underline
